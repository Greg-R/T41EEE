...
void SetFreq() {                                               //AFP 09-22-22   Revised July 7 KF5N
  ...
  if (radioState == RadioState::SSB_TRANSMIT_STATE or radioState == RadioState::SSB_IM3TEST_STATE or radioState == RadioState::FT8_TRANSMIT_STATE or radioState == RadioState::CW_TRANSMIT_STRAIGHT_STATE
      or radioState == RadioState::CW_TRANSMIT_KEYER_STATE or radioState == RadioState::CW_TRANSMIT_IAMBIC_STATE) {  // Transmit state
    si5351.set_freq(Clk2SetFreq, SI5351_CLK2);
